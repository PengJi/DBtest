--
CREATE or replace VIEW PhotoPrimary_20 
----------------------------------------------------------------------
...
----------------------------------------------------------------------
AS
SELECT * FROM PhotoObjAll_20 
    WHERE mode=1;

--
CREATE or replace VIEW Galaxy_20
---------------------------------------------------------------
...
--
CREATE or replace VIEW PhotoObj_20
----------------------------------------------------------------------
...
--
CREATE or replace VIEW Star_20
--------------------------------------------------------------
...
--
CREATE or replace VIEW SpecObj_20 
---------------------------------------------------------------
