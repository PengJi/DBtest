--
CREATE or replace VIEW PhotoPrimary_50 
----------------------------------------------------------------------
...
----------------------------------------------------------------------
AS
SELECT * FROM PhotoObjAll_50 
    WHERE mode=1;

--
CREATE or replace VIEW Galaxy_50
---------------------------------------------------------------
...
--
CREATE or replace VIEW PhotoObj_50
----------------------------------------------------------------------
...
--
CREATE or replace VIEW Star_50
--------------------------------------------------------------
...
--
CREATE or replace VIEW SpecObj_50 
---------------------------------------------------------------
